...
public class MailTests extends TestBase{
    ...
    public void canReceiveMail(){
        var mails = app.mail().receive(app.property( "mailbox"),app.property("mailbox.pwd"), Duration.ofSeconds(10));
        Assertions.assertEquals(1,mails.size());
        System.out.println(mails);
    }
    @Test
    public void canDrainInboxTest(){
        app.mail().drain(app.property( "mailbox"),app.property("mailbox.pwd"));
